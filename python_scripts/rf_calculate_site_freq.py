...
def parse_rockfish(path, get_predicted=False, type_suffix=''):
    rockfish = pl.scan_csv(path, has_header=True, separator='\t')
...
def main(args):
    ...
    read_level.write_csv(args.output, has_header=False, separator='\t')
...
def get_arguments() -> argparse.Namespace:
    ...
    parser.add_argument('-o', '--output', type=str, default='site_freq.bedGraph')
